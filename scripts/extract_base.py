...
def write_base(text_group, text_id, version="perseus-grc2", refs_filter=None):
    ...
    with open(
        f"base-texts/{text_group}/{text_group}.{text_id}.{version}.base.tsv", "w"
    ) as g:
...
write_base("tlg0003", "tlg001", refs_filter=lambda refs: refs[0] in ["1", "2", "3", "4", "5"])
...
# Run scripts/convert_plato_texts.py instead
